...
namespace WpaGhApp.Services
{
    public interface IGitHubService
    {
        ...
        Task<IReadOnlyList<RepositoryContent>> GetContentsAsync(IGitHubRepositoryIdentifiers repositoryIdentifiers,
            string contentPath);
        Task<TreeResponse> GetTreeRecursiveAsync(IGitHubRepositoryIdentifiers repositoryIdentifiers, string sha);
        Task<IReadOnlyList<Branch>> GetBranchesAsync(IGitHubRepositoryIdentifiers repositoryIdentifiers);
    }
}
